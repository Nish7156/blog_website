...
function UniqueCard({ele}:any) {
  return (
    <>
        <div className="p-6 mr-6 text-white bg-purple-600 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <a href="#">
          <h5 className="mb-2 text-2xl font-semibold tracking-tight text-white dark:text-white">{ele.attributes.title}</h5>
      </a>
