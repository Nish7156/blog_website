...
function Card({Article}:any) {
    ...
    const DesArticles = Article.sort(
...
{DesArticles.map((ele:any,index:number)=>{
    return <>
    {index===1? <UniqueCard ele={ele}/> :
      <div className="p-6 mr-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
